...
namespace Arad.Areas.TeamOwner.Controllers
{
    public class RequestController : Controller
    {
        ...
        {
            ViewBag.RefereeAccountId = new SelectList(db.Account.Where(q => q.RoleId == (int)Enums.Roles.Referee), "Id", "PhoneNumber");
        ...
        public ActionResult Create([Bind(Include = "Id,HostTeamId,GuestTeamId,Type,RefereeAccountId")] Request request)
        {
            ...
            ViewBag.RefereeAccountId = new SelectList(db.Account.Where(q => q.RoleId == (int)Enums.Roles.Referee), "Id", "PhoneNumber", request.RefereeAccountId);
